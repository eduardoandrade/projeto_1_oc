...
def print_memoria_cache(memoria_cache, num_conjuntos):
  ...
  print("/--------------------------\")
  if num_conjuntos ==0:
        print("|      memoria_cahe Direto        |")
  elif  num_conjuntos ==1:
        print("|     memoria_cahe Associativo    |")
  else:
        print("|memoria_cahe Associativo Conjunto|")
  print("|------------------------------|")
  if num_conjuntos >1:
        print("|Tamanho: {:>11}|\n|Conjuntos: {:>10}|".format(len(memoria_cahe), num_conjuntos))
  else:      
        print("|Tamanho memoria_cahe: {:>21}| ".format(len(memoria_cahe)))
  print("|------------------------------|")
  if num_conjuntos <=1:
        print("|Pos memoria_cahe |Posição Memória|")
        print("|----------|---------------|")
        for posicao, valor in memoria_cahe.items():
